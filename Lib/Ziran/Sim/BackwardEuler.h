...
public:
    ...
    virtual void recoverSolution(TVStack& ddv) {}
    virtual void transformResidual(TVStack& r) {}

    virtual bool shouldExitByCN(const TVStack&)
    {
        ZIRAN_WARN("shouldExitByCN not overloaded!");
        return true;
    }
