...
#if (__cplusplus == 201103L || defined(TL_FUNCTION_REF_MSVC2015) || defined(TL_FUNCTION_REF_GCC49)) && !defined(TL_FUNCTION_REF_GCC54)
/// \exclude
...
public:
    ...
    template <typename F,
        detail::enable_if_t<
            !std::is_same<detail::decay_t<F>, function_ref>::value && detail::is_invocable_r<R, F&&, Args...>::value>* = nullptr>
    ...
    template <typename F,
        detail::enable_if_t<detail::is_invocable_r<R, F&&, Args...>::value>* = nullptr>
